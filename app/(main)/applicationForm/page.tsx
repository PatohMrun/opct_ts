...
const ApplicationForm: React.FC = () => {
    ...
    const fetchUserData = async () => {
      ...
      try {
        const response = await fetch(
          `/api/applicationForm?nationalId=${user.nationalId}`
        );
        if (!response.ok) {
          console.log(
            "tyuiyuiusdewyretyuifrfwtrrwtyrwrucdffhdufefniedfjeiejeu"
          );
        ...
        setDob(
          new Date(userData.governmentRecord.dob).toISOString().split("T")[0]
        );
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center py-4 fixed inset-0">
    ...
    <form className="max-w-3xl mx-auto p-4">
      <FormSection title="Personal Information">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label htmlFor="personalDob" className="block text-sm font-medium">
              Date of Birth *
            </label>
            <input
              type="date"
          ...
          <div>
            <label
              htmlFor="personalMarital"
              className="block text-sm font-medium"
            >
              Marital Status *
            </label>
            <select
              name="personalMarital"
              value={marital}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input
              type="text"
              id="addressSubcounty"
              name="addressSubcounty"
              value={subCounty}
              onChange={(e) => setSubCounty(e.target.value)}
              className="mt-1 block w-full p-2 border border-gray-300 rounded-md text-gray-900"
              placeholder="E.g., Embu-East"
              required
            />
          </div>
          <div>
            <label
              htmlFor="addressConstituency"
              className="block text-sm font-medium"
            >
              Constituency *
            </label>
            <input
              type="text"
              id="addressConstituency"
              name="addressConstituency"
              value={constituency}
              onChange={(e) => setConstituency(e.target.value)}
              className="mt-1 block w-full p-2 border border-gray-300 rounded-md text-gray-900"
              placeholder="E.g., Runyenjes"
              required
            />
          </div>
          <div>
            <label htmlFor="addressWard" className="block text-sm font-medium">
              Ward *
            </label>
            <input
              type="text"
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full p-2 border border-gray-300 rounded-md text-gray-900"
              placeholder="E.g., Kagaari-South-West"
              required
            />
          </div>
          <div>
            <label
              htmlFor="addressSublocation"
              className="block text-sm font-medium"
            >
              Sub-Location *
            </label>
            <input
              type="text"
              id="addressSublocation"
              name="addressSublocation"
              value={subLocation}
              onChange={(e) => setSubLocation(e.target.value)}
              className="mt-1 block w-full p-2 border border-gray-300 rounded-md text-gray-900"
              placeholder="E.g., Nthagaiya"
              required
            />
          </div>
          <div>
      ...
      <FormSection title="Socio-Economic Information">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <input
              type="text"
              id="socioEconomicIncome"
              name="socioEconomicIncome"
              value={income}
          ...
          <div>
            <label
              htmlFor="socioEconomicEmployment"
              className="block text-sm font-medium"
            >
              Employment Status *
            </label>
            <select
              name="socioEconomicEmployment"
              value={employment}
              onChange={(e) => setEmployment(e.target.value)}
              id="socioEconomicEmployment"
              className="mt-1 block w-full p-2 border border-gray-300 rounded-md text-gray-900"
              required
            >
              <option value="" disabled selected>
          ...
          <div>
            <label
              htmlFor="socioEconomicAssistance"
              className="block text-sm font-medium"
            >
              Other Assistance
            </label>
            <input
              type="text"
              id="socioEconomicAssistance"
              name="socioEconomicAssistance"
              value={assistance}
              onChange={(e) => setAssistance(e.target.value)}
              className="mt-1 block w-full p-2 border border-gray-300 rounded-md text-gray-900"
              placeholder="E.g., Other Inuajamii Schemes"
            />
          </div>
          <div>
            <label
              htmlFor="socioEconomicIllness"
              className="block text-sm font-medium"
            >
              Chronic Illness *
            </label>
            <select
              name="socioEconomicIllness"
              value={illness}
              onChange={(e) => setIllness(e.target.value)}
              id="socioEconomicIllness"
              className="mt-1 block w-full p-2 border border-gray-300 rounded-md text-gray-900"
              required
            >
              <option value="" disabled selected>
          ...
          <div>
            <label
              htmlFor="socioEconomicDisabled"
              className="block text-sm font-medium"
            >
              Disabled *
            </label>
            <select
              name="socioEconomicDisabled"
              value={disabled}
              onChange={(e) => setDisabled(e.target.value)}
              id="socioEconomicDisabled"
              className="mt-1 block w-full p-2 border border-gray-300 rounded-md text-gray-900"
              required
            >
              <option value="" disabled selected>
      ...
      <FormSection title="Bank Details">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label htmlFor="bankBankName" className="block text-sm font-medium">
              Bamk Name{" "}
            </label>
            <input
              type="text"
      ...
      <FormSection title="Alternate Payee">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label
              htmlFor="alternatePayeeFirstName"
              className="block text-sm font-medium"
            >
              First Name{" "}
            </label>
            <input
              type="text"
              id="alternatePayeeFirstName"
              name="alternatePayeeFirstName"
          ...
          <div>
            <label
              htmlFor="alternatePayeeMiddleName"
              className="block text-sm font-medium"
            >
              Middle Name
            </label>
            <input
              type="text"
              id="alternatePayeeMiddleName"
              name="alternatePayeeMiddleName"
          ...
          <div>
            <label
              htmlFor="alternatePayeeLastName"
              className="block text-sm font-medium"
            >
              Last Name{" "}
            </label>
            <input
              type="text"
              id="alternatePayeeLastName"
              name="alternatePayeeLastName"
              value={payeeLastName}
          ...
          <div>
            <label
              htmlFor="alternatePayeeBankName"
              className="block text-sm font-medium"
            >
              Bank Name{" "}
            </label>
            <input
              type="text"
              id="alternatePayeeBankName"
              name="alternatePayeeBankName"
              value={payeeBankName}
          ...
          <div>
            <label
              htmlFor="alternatePayeeAccountNumber"
              className="block text-sm font-medium"
            >
              Account No.
            </label>
            <input
              type="text"
              id="alternatePayeeAccountNumber"
              name="alternatePayeeAccountNumber"
      ...
      <FormSection title="Dependants">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label htmlFor="dependentDob" className="block text-sm font-medium">
              Date of Birth
            </label>
            <input
              type="date"
      ...
      <div className="flex justify-end">
        <button
          className="bg-primary text-secondary py-2 px-4 rounded-md hover:bg-secondary hover:text-gray-900 transition-colors"
