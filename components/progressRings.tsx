...
const ProgressRings = () => {
  ...
  return (
    <div className="bg-white m-4 rounded-lg p-6 shadow-lg">
      <h1 className="text-center uppercase font-poppins font-bold text-xl my-4">
        Application Status
      </h1>
      ...
      <section className="font-poppins flex flex-col sm:flex-row justify-center items-center gap-6">
        ...
        <hr
          className={`w-16 sm:w-24 border-black transform rotate-90 sm:transform-none ${
        ...
        <hr
          className={`w-16 sm:w-24 border-black transform rotate-90 sm:transform-none ${
            status === "Rejected" ? "border-blue-600" : ""
          }`}
        />
        {/* Ring three */}
        <div
